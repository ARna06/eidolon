...
#define eidolon_trace(...) ::core::log_t::log_trace(std::format(__VA_ARGS__))
#define eidolon_info(...) ::core::log_t::log_info(std::format(__VA_ARGS__))
#define eidolon_warn(...) ::core::log_t::log_warn(std::format(__VA_ARGS__))
#define eidolon_error(...) ::core::log_t::log_error(std::format(__VA_ARGS__))
